...
utilities: {
    ...
    // Previously this contacted the subscription API and displayed a
    // warning when no valid subscription was found. To disable the popup
    // while keeping the command flow intact, simply execute the callback
    // directly.
